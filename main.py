...
# [REMOVIDO DUPLICADO] comando /item_criar já definido acima.
...
# [REMOVIDO DUPLICADO] comando /item_excluir já definido acima.
...
# [REMOVIDO DUPLICADO] comando /ping já definido acima.
# [REMOVIDO DUPLICADO] comando /start já definido acima.
# [REMOVIDO DUPLICADO] comando /perfil já definido acima.
# [REMOVIDO DUPLICADO] comando /comandos já definido acima.
# [REMOVIDO DUPLICADO] comando /inventario já definido acima.
# [REMOVIDO DUPLICADO] comando /comprar já definido acima.
# [REMOVIDO DUPLICADO] comando /vender já definido acima.
# [REMOVIDO DUPLICADO] comando /equipar já definido acima.
# [REMOVIDO DUPLICADO] comando /desequipar já definido acima.
# [REMOVIDO DUPLICADO] comando /desequiparanel já definido acima.
# [REMOVIDO DUPLICADO] comando /usar já definido acima.
# [REMOVIDO DUPLICADO] comando /upar já definido acima.
# [REMOVIDO DUPLICADO] comando /enviargold já definido acima.
# [REMOVIDO DUPLICADO] comando /doaritem já definido acima.
# [REMOVIDO DUPLICADO] comando /descansar já definido acima.
# [REMOVIDO DUPLICADO] comando /albergue já definido acima.
# [REMOVIDO DUPLICADO] comando /magias já definido acima.
# [REMOVIDO DUPLICADO] comando /livro_equipar já definido acima.
# [REMOVIDO DUPLICADO] comando /livro_desequipar já definido acima.
# [REMOVIDO DUPLICADO] comando /cacar já definido acima.
# [REMOVIDO DUPLICADO] comando /spawn já definido acima.
# [REMOVIDO DUPLICADO] comando /darxp já definido acima.
# [REMOVIDO DUPLICADO] comando /dargold já definido acima.
# [REMOVIDO DUPLICADO] comando /dargold_individual já definido acima.
# [REMOVIDO DUPLICADO] comando /daritem já definido acima.
# [REMOVIDO DUPLICADO] comando /spell_criar já definido acima.
# [REMOVIDO DUPLICADO] comando /spell_ativar já definido acima.
# [REMOVIDO DUPLICADO] comando /spell_desativar já definido acima.
# [REMOVIDO DUPLICADO] comando /spell_excluir já definido acima.
# [REMOVIDO DUPLICADO] comando /item_editar já definido acima.
# [REMOVIDO DUPLICADO] comando /item_excluir já definido acima.
# [REMOVIDO DUPLICADO] comando /loja_add já definido acima.
# [REMOVIDO DUPLICADO] comando /loja_remove já definido acima.
# [REMOVIDO DUPLICADO] comando /loja_set já definido acima.
# [REMOVIDO DUPLICADO] comando /bau_add já definido acima.
# [REMOVIDO DUPLICADO] comando /bau_remove já definido acima.
# [REMOVIDO DUPLICADO] comando /bau_listar já definido acima.
# [REMOVIDO DUPLICADO] comando /bau_dar já definido acima.
# [REMOVIDO DUPLICADO] comando /magia_criar já definido acima.
# [REMOVIDO DUPLICADO] comando /magia_editar já definido acima.
# [REMOVIDO DUPLICADO] comando /magia_excluir já definido acima.
# [REMOVIDO DUPLICADO] comando /resetar já definido acima.
# [REMOVIDO DUPLICADO] comando /setlevel já definido acima.
# [REMOVIDO DUPLICADO] comando /mdano já definido acima.
# [REMOVIDO DUPLICADO] comando /mcurar já definido acima.
# [REMOVIDO DUPLICADO] comando /mstatus já definido acima.
