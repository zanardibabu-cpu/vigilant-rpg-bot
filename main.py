...
async def seed_initial_data():
    """
    Seed idempotente: garante itens/spells iniciais e ativa o que precisa sem quebrar schema.
    """
    # Itens (usa UPSERT via item_upsert)
    await seed_initial_items()

    # Itens ativos na shop_items (se você usa essa tabela)
    async with aiosqlite.connect(DB_FILE) as db:
